...
Source of truth: `wiki/tdd/ls-web-tdd.md`
...
The wiki folder is organized by document type:
...
1. `wiki/tdd/ls-web-tdd.md`
2. `wiki/api/ls-web-api_specification.md`
3. `wiki/database/ls-web-database-schema.md`
4. `wiki/project-structure/ls-web-project-structure.md`
5. Diagram and flow docs
6. `wiki/testing/ls-web-test-specification.md`
7. Root `AGENTS.md`
...
Canonical AI roles, skills, overlays, workflows, and tool policies live in `.agents/`. Tool-specific adapters such as `.claude/`, `.codex/`, `.cursor/`, `.github/`, and `.opencode/` are generated or synchronized from the canonical sources.
