...
- Phase 2 context routing: implemented in `.ai/context-routing.md`.
- Phase 3 curated maps: implemented in `.ai/maps/`.
- Phase 4 generated local index: implemented in `.ai/index/` and `scripts/generate-ai-index.mjs`.
- Phase 5 tool workflow: implemented in `wiki/ai/context-strategy.md` and `.agents/tools/`.
